...
exports.testWhite = {
	...
	testDarkest: function(test){
		...
		async.series([
			function(cb){
				testCommand('darkest',0,[0x35,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34],server,test,cb);
			},
			function(cb){
				testCommand('darkest',1,[0x38,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34],server,test,cb);
			},
			function(cb){
				testCommand('darkest',2,[0x3d,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34],server,test,cb);
			},
			function(cb){
				testCommand('darkest',3,[0x37,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34],server,test,cb);
			},
			function(cb){
